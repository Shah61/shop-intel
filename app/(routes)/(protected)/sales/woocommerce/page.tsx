...
const topSellersData = [
    { id: 1, name: "Hydrating Face Serum", quantity: 245, domain: "beauty.com" },
    { id: 2, name: "Anti-Aging Night Cream", quantity: 198, domain: "beauty.com" },
    { id: 3, name: "Vitamin C Brightening Serum", quantity: 167, domain: "beauty.com" },
    { id: 4, name: "Gentle Facial Cleanser", quantity: 156, domain: "beauty.com" },
    { id: 5, name: "Moisturizing Day Cream", quantity: 134, domain: "beauty.com" },
    { id: 6, name: "Eye Contour Gel", quantity: 123, domain: "beauty.com" },
    { id: 7, name: "Exfoliating Face Scrub", quantity: 98, domain: "beauty.com" },
    { id: 8, name: "Facial Toner", quantity: 87, domain: "beauty.com" }
];

// Static data for orders
const ordersData = [
    { id: "#1001", status: "Completed", total: 125.50, date: "2025-01-15", domain: "beauty.com", items: ["Hydrating Face Serum", "Gentle Facial Cleanser"] },
    { id: "#1002", status: "Processing", total: 89.90, date: "2025-01-15", domain: "beauty.com", items: ["Anti-Aging Night Cream"] },
    { id: "#1003", status: "Completed", total: 156.75, date: "2025-01-14", domain: "beauty.com", items: ["Vitamin C Brightening Serum", "Eye Contour Gel"] },
    { id: "#1004", status: "Shipped", total: 67.25, date: "2025-01-14", domain: "beauty.com", items: ["Moisturizing Day Cream"] },
    { id: "#1005", status: "Completed", total: 198.00, date: "2025-01-13", domain: "beauty.com", items: ["Hydrating Face Serum", "Anti-Aging Night Cream", "Facial Toner"] }
];

// Static data for daily sales
const dailySalesData = [
    { date: "2025-01-15", sales: 9200, orders: 92, currency: "MYR", domain: "beauty.com" },
    { date: "2025-01-14", sales: 8900, orders: 89, currency: "MYR", domain: "beauty.com" },
    { date: "2025-01-13", sales: 7500, orders: 75, currency: "MYR", domain: "beauty.com" },
    { date: "2025-01-12", sales: 8200, orders: 82, currency: "MYR", domain: "beauty.com" },
    { date: "2025-01-11", sales: 7800, orders: 78, currency: "MYR", domain: "beauty.com" },
    { date: "2025-01-10", sales: 6500, orders: 65, currency: "MYR", domain: "beauty.com" },
    { date: "2025-01-09", sales: 7200, orders: 72, currency: "MYR", domain: "beauty.com" }
];
...
const BADGE_CONFIG: Record<string, { label: string; gradient: string; shadow: string }> = {
    ...
    "beauty.com": { label: "beauty.com", gradient: "linear-gradient(135deg, var(--preset-primary), var(--preset-lighter))", shadow: "0 2px 8px rgba(var(--preset-primary-rgb), 0.35)" },
                ...
                <div className="flex flex-wrap items-center gap-3">
                    ...
                    <Select value={selectedDomain} onValueChange={setSelectedDomain}>
                        ...
                        <SelectContent>
                            ...
                            <SelectItem value="beauty.com">beauty.com</SelectItem>
