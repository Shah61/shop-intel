...
const genCampaigns = () => {
  const c: any[] = [];
  const types = ["Clothing Lovers","Premium Collection","Valentine Special","Easter Delight","Summer Treats","Dark Clothing","Milk Clothing","White Clothing","Hazelnut Crunch","Caramel Bliss","Strawberry Dream","Mint Fresh","Orange Zest","Raspberry Ripple","Vanilla Cream","Coconut Paradise","Almond Joy","Peanut Butter","Cookies & Cream","Rocky Road","Birthday Celebration","Anniversary Special","Holiday Collection","Gift Box","Party Pack","Luxury Selection","Artisan Crafted","Organic Choice","Sugar Free","Gluten Free","Kids Favorite","Adult Indulgence","Corporate Gifts","Wedding Favors","Graduation Treats","Mother's Day","Father's Day","Christmas Magic","New Year Joy","Back to School","Halloween Spooky","Thanksgiving Feast","Black Friday","Cyber Monday","Flash Sale","Limited Edition","Seasonal Special","Regional Favorite","International Blend","Local Pride","Morning Boost","Afternoon Pick","Evening Relax","Midnight Snack","Weekend Treat","Workplace Energy","Study Buddy","Gym Reward","Travel Companion","Home Comfort","Date Night","Movie Night","Game Night","Book Club","Coffee Break","Tea Time","Dessert Time","Snack Time","Treat Time","Reward Time","Achievement","Milestone","Success","Victory","Celebration","Memories","Nostalgia","Tradition","Heritage","Legacy","Innovation","Revolution","Evolution","Transformation","Discovery","Adventure","Exploration","Journey","Experience","Passion","Love","Joy","Happiness","Bliss","Comfort","Warmth","Cozy","Snug","Peaceful"];
...
const genAds = () => {
  const a: any[] = [];
  const types = ["Clothing Bar","Truffle Box","Gift Set","Party Pack","Luxury Collection","Dark Delight","Milk Magic","White Wonder","Hazelnut Heaven","Caramel Dream","Strawberry Surprise","Mint Marvel","Orange Bliss","Raspberry Joy","Vanilla Velvet","Coconut Cream","Almond Art","Peanut Perfection","Cookie Crunch","Rocky Road","Birthday Box","Anniversary Gift","Holiday Hamper","Gift Wrapped","Party Favor","Luxury Line","Artisan Special","Organic Choice","Sugar Free","Gluten Free","Kids Pack","Adult Treat","Corporate Gift","Wedding Favor","Graduation Gift","Mother's Love","Father's Pride","Christmas Joy","New Year Gift","School Treat"];
