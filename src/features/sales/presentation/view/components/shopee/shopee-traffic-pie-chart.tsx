...
const colors = {
    visitors: "#EE4D2D", // Shopee's primary orange
    orders: "#F1582C", // Shopee's secondary orange
    conversion: "#213440", // Shopee's dark navy/slate color
    // Shades for monthly breakdowns
    visitorsShades: ["#EE4D2D", "#F06847", "#F28462"],
    ordersShades: ["#F1582C", "#F37A56", "#F59C80"],
    conversionShades: ["#213440", "#3A5064", "#536C88"]
};
...
export default ShopeeTrafficPieChart;