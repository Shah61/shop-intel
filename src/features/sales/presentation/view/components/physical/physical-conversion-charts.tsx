...
interface PhysicalConversionChartsProps {
    isAdmin?: boolean;
}

export function PhysicalConversionCharts({ isAdmin = false }: PhysicalConversionChartsProps) {
        ...
        <Card className="shadow-sm relative">
            <CardHeader className="pb-3">
                <div className="flex flex-col md:flex-row md:items-center justify-between gap-2">
                    <div>
                        <CardTitle className="text-lg font-bold">Physical Store Conversion Metrics</CardTitle>
