...
import { PhysicalConversionTable } from "./physical-conversion-table";

const DialogPhysicalConversionTable = () => {
    ...
    return (
        <Dialog>
            ...
            <DialogContent className="w-full max-w-[90%] md:max-w-[80%] lg:max-w-[70%] xl:max-w-[60%] px-4 md:px-6 rounded-lg max-h-[80vh] overflow-y-auto">
                ...
                <PhysicalConversionTable isLimit={false} />
...
export default DialogPhysicalConversionTable;