...
const colors = {
    visitors: "#008060", // Shopify green
    orders: "#5C6AC4", // Shopify purple/indigo
    conversion: "#212B36", // Shopify ink (dark slate)
    // Shades for monthly breakdowns
    visitorsShades: ["#008060", "#00A376", "#00C58C"], // Green shades
    ordersShades: ["#5C6AC4", "#7D88D1", "#9EA7DE"], // Purple shades
    conversionShades: ["#212B36", "#454F5B", "#637381"] // Slate shades
};
...
export default ShopifyTrafficPieChart;