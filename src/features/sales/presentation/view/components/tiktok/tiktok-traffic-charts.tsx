...
//     visitors: {
//         label: "Visitors",
//         color: "hsl(230, 70%, 50%)", // Blue for Visitors
//     },
//     orders: {
//         label: "Orders",
//         color: "hsl(120, 60%, 40%)", // Green for Orders
//     },
//     conversionRate: {
//         label: "Conversion Rate",
//         color: "hsl(340, 80%, 75%)", // Pink for Conversion
//     },
...
const chartConfig = {
    visitors: {
        label: "Visitors",
        color: "#1AC0BB", // Darker teal/cyan
    },
    orders: {
        label: "Orders",
        color: "#E6173D", // Darker red/pink
    },
    conversionRate: {
        label: "Conversion",
        color: "#333333", // Dark gray instead of pure black for better contrast
    },
} satisfies ChartConfig

export function TiktokTrafficCharts() {
